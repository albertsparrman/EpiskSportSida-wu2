...
function myFunc(p1, p2) {
    ...
    if (i == 1) {
        ...
        document.getElementById("news").style.backgroundImage = "url(/img/IsnHfFW2iB-600.jpeg)"
    ...
    if (i == 2) {
        ...
        document.getElementById("news").style.backgroundImage="url(/img/gY7PVfVEPZ-600.jpeg)"
    ...
    if (i == 3) {
        ...
        document.getElementById("news").style.backgroundImage="url(/img/H64sPhU0cR-600.jpeg)"
